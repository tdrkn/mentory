...
Mentory - платформа, где менти находит ментора, выбирает разовую консультацию или программу, отправляет заявку, оплачивает работу и дальше ведет прогресс через сессии, чат, задачи и материалы. Основной автор и продуктовый лидер текущей реализации - Растяпин Данил.
...
- 16 менторов, включая профиль автора проекта Растяпина Данила;
- 3 менти;
- 1 администратор;
...
| Ментор / автор проекта | `danil.rastyapin@example.com` | `password123` |
...
- Расширены demo-data, добавлен видимый профиль Растяпина Данила как автора проекта.
