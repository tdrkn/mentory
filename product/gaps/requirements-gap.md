...
|---|---|---|---|
| Профиль ментора (просмотр) | В исходном PDF встречался вариант с табами `Сессия / Подписка`, но последние приложенные PNG закрепили два отдельных правых блока: **Планы подписки** и **Разовые сессии и услуги** | Hero, разделы и два правых блока есть; CTA/selection работают | Структурно закрыто. Остаются data gaps: фото, навыки, хобби, достижения, RUB-only demo data |
